...
ffbuild_cxxflags() {
    echo "-I$FFBUILD_PREFIX/include/torch/csrc/api/include -D_GLIBCXX_USE_CXX11_ABI=1 -DNOMINMAX -DNDEBUG -DCPPUID_STATIC -DCAFFE2_USE_MKL -DCAFFE2_USE_OPENMP -DUSE_DISTRIBUTED -DUSE_C10D_GLOO"
}
