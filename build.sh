...
CONF_FLAGS=(
    ...
    --extra-cflags="-O2 -march=x86-64-v3 -mtune=generic -pipe -fstack-protector-strong -mstackrealign -std=gnu23 -I/opt/ffbuild/include -D_FORTIFY_SOURCE=2"
    --extra-cxxflags="-O2 -march=x86-64-v3 -mtune=generic -pipe -fstack-protector-strong -mstackrealign -std=gnu++20 -I/opt/ffbuild/include -D_FORTIFY_SOURCE=2"
