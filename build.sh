...
CONF_FLAGS=(
    ...
    --extra-cflags="-O2 -march=x86-64-v3 -mtune=generic -pipe -fstack-protector-strong -std=gnu23 -I/opt/ffbuild/include"
    --extra-cxxflags="-O2 -march=x86-64-v3 -mtune=generic -pipe -fstack-protector-strong -std=gnu++20 -I/opt/ffbuild/include"
