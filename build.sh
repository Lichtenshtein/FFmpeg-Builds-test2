...
CONF_FLAGS=(
    ...
    --extra-cflags="-O3 -march=broadwell -mtune=broadwell -mavx2 -mfma -ftree-vectorize -pipe -mms-bitfields -fstack-protector-strong -mstackrealign -std=gnu23 -I/opt/ffbuild/include -D_FORTIFY_SOURCE=2"
    --extra-cxxflags="-O3 -march=broadwell -mtune=broadwell -mavx2 -mfma -ftree-vectorize -pipe -mms-bitfields -fstack-protector-strong -mstackrealign -std=gnu++20 -I/opt/ffbuild/include -D_FORTIFY_SOURCE=2"
