...
CONF_FLAGS=(
    ...
    --extra-cflags="-O3 -march=broadwell -mtune=broadwell -mavx2 -mfma -ftree-vectorize -pipe -g -fno-var-tracking-assignments -mms-bitfields -fstack-protector-strong -mstackrealign -Wno-attributes -ffunction-sections -fdata-sections -std=gnu23 -I/opt/ffbuild/include -D_FORTIFY_SOURCE=2"
    --extra-cxxflags="-O3 -march=broadwell -mtune=broadwell -mavx2 -mfma -ftree-vectorize -pipe -g -fno-var-tracking-assignments -mms-bitfields -fstack-protector-strong -mstackrealign -Wno-attributes -ffunction-sections -fdata-sections -std=gnu++20 -I/opt/ffbuild/include -D_FORTIFY_SOURCE=2"
