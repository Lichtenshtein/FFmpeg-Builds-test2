...
# FF_LDFLAGS="-L/opt/ffbuild/lib -static-libgcc -static-libstdc++ -lm -Wl,--high-entropy-va -Wl,--nxcompat -Wl,--dynamicbase -Wl,--stack,16777216"
# FF_LIBS="-lsetupapi -lole32 -lshlwapi -luser32 -ladvapi32 -ldbghelp -lws2_32 -lbcrypt -lm"
