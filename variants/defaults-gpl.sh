...
FF_LDFLAGS="-L/opt/ffbuild/lib -static-libgcc -static-libstdc++ -pthread -lssp -Wl,--high-entropy-va -Wl,--nxcompat -Wl,--dynamicbase -Wl,--stack,16777216 -Wl,--large-address-aware"
